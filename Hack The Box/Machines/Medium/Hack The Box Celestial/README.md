...
El punto de partida fue el examen de la aplicación web expuesta, cuya superficie de ataque inicial parecía carente de vectores evidentes. No obstante, la inspección de los artefactos de sesión reveló una 
cookie codificada en Base64 que, tras su decodificación, resultó ser un objeto en formato JSON. Este hallazgo condujo a la hipótesis de una posible deserialización insegura en un entorno Node.js, 
hipótesis que se confirmó al explotar la vulnerabilidad CVE-2017-5941 en la librería node-serialize.
